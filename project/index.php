        ...
        <div class="container">
            ...
            <div class="collapse navbar-collapse" id="ftco-nav">
                ...
                <li class="nav-item active"><a href="" class="nav-link"><i class="fas fa-home"></i>
                    ...
                    <li class="nav-item"><a href="Guest/Login.php" class="nav-link"><i class="fas fa-sign-in-alt"></i> Login</a></li>
                    <li class="dropdown">

                    <li class="nav-item dropdown">
            <a class="nav-link dropdown-toggle" data-toggle="dropdown" href="#" role="button" aria-haspopup="true" aria-expanded="false"><i class="fas fa-user-plus"></i>
                Sign In
            </a>
            <div class="dropdown-menu">
                <a class="dropdown-item" href="Guest/NewUser.php">As User</a>
                <a class="dropdown-item" href="Guest/Staff.php">As Staff</a>
            </div>
        </li>
</ul>
        </div>
        ...
        <div class="container">
            <div class="row no-gutters slider-text js-fullheight align-items-center" data-scrollax-parent="true">
                <div class="col-md-7 ftco-animate">
                    ...
                    <p class="caps">"The key to the mystery of a great artist is that for reasons unknown, he will give away his energies and his life just to make sure that one note follows another... and leaves us with the feeling that something is right in the world." 
                        <br>- Leonard Bernstein</p>
                ...
                <div class="col-md pt-5">
                    <div class="ftco-footer-widget pt-md-5 mb-4">
                        ...
                        <!-- <ul class="ftco-footer-social list-unstyled float-md-left float-lft">
                            <li class="ftco-animate"><a href="#"><span class=""></span></a></li>
