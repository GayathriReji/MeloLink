...
?>
        <script>
            alert('Deleted');
            window.location = "StaffComplaint.php";
        </script>
<?php
    } else {
?>
...
?>
        ...
        $insQry = "INSERT INTO tbl_complaints(cmp_title, cmp_content, cmp_date, staff_id) VALUES('" . $cmptitle . "','" . $cmpcontent . "',CURDATE(),'" . $_SESSION["sid"] . "')";
        if ($con->query($insQry)) {
            ?>
            <script>
            alert('Inserted');
    ...
    <div class="container">
        ...
        <form id="form2" name="form2" method="post" action="">
            ...
            <table class="table">
                ...
                <tbody>
                    <?php
                    $select = "SELECT * FROM tbl_complaints WHERE staff_id=" . $_SESSION['sid'];
                    ...
                    ?>
                        <tr>
                            ...
                            <td>
                                <a href="StaffComplaint.php?did=<?php echo $row['cmp_id']; ?>" class="btn btn-danger">Delete</a>
                                <a href="StaffComplaint.php?eid=<?php echo $row['cmp_id']; ?>" class="btn btn-warning">Edit</a>
                            </td>
                        </tr>
                    <?php
                    }
