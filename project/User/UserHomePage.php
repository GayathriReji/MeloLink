...
<head>
    <title>MeloLink User HomePage</title>
    <meta charset="utf-8">
...
<body>
        ...
        <div class="container">
            <div class="row no-gutters slider-text js-fullheight align-items-center" data-scrollax-parent="true">
                <div class="col-md-7 ftco-animate">
                    ...
                    <p class="caps">"The key to the mystery of a great artist is that for reasons unknown, he will give
                        away his energies and his life just to make sure that one note follows another... and leaves us
                        with the feeling that something is right in the world." <br>- Leonard Bernstein</p>
                     <p class="mb-0"><a href="AllCourseview.php ?>" class="btn btn-primary">Our Course</a><!-- <a href="#"
            ...
            <div class="row justify-content-center pb-4">
                ...
                <div class="col-md-4 ftco-animate">
                    <div class="project-wrap">
                        <a href="CourseView.php?cid=<?php echo $row['course_id'] ?>" class="img"
                        ...
                        <div class="text p-4">
                            ...
                            <p class="advisor"><span>
                                    <?php echo $row['course_duration']; ?> Months
                                </span></p>
                            <ul class="d-flex justify-content-between">
                                <li><span class="flaticon-shower"></span></li>
                                <li class="price">
                                    <?php echo $row['course_rate'];?>
                                </li>
                            </ul>
                            <!-- <h3>
                                <a href="MaterialView.php?mid=<?php echo $row['course_id']; ?>"
                                    class="btn btn-primary btn-sm" style="display: inline-block;">
                                    <i class="fas fa-eye"></i> Material
                                </a>
                                <a href="TutorialView.php?tid=<?php echo $row['course_id']; ?>"
                                    class="btn btn-primary btn-sm" style="display: inline-block;">
                                    <i class="fas fa-eye"></i> Tutorial
                                </a>
                            </h3> -->
    ...
    <section class="ftco-section ftco-counter img" id="section-counter"
        style="background-image: url(../Assets/Template/Main/images/bg2.jpg);">
        <div class="overlay"></div>
        <div class="container">
            <div class="row">
                        ...
                        <div class="col-md-6 pl-md-5 py-5">
                            <div class="row justify-content-start pb-3">
                                <div class="col-md-12 heading-section ftco-animate">
                                    ...
                                    <p>Discover the joy of making music as you learn from world-class musicians and
                                        educators.Our online music classes are your gateway to mastering your
                                        instrument, understanding music theory, and unleashing your inner composer.</p>
            ...
            <div class="row d-flex">
                <div class="col-md-6 heading-section pr-md-5 ftco-animate d-flex align-items-center">
                    <div class="w-100 mb-4 mb-md-0">
                        ...
                        <p>We bring the world of music right to your screen, making it easier than ever to start your
                            musical journey.Unlock the mysteries of music with our engaging and interactive classes.
                            Start your musical adventure today!</p>
                        <!-- <div class="d-flex video-image align-items-center mt-md-4">
                            ...
                            <h4 class="ml-4">Learn anything from MeloLink, Watch video</h4>
                        </div> -->
                    </div>
                </div>
                <div class="col-md-6">
                        ...
                        <div class="col-md-12 col-lg-6 d-flex align-self-stretch ftco-animate">
                            <div class="services">
                                ...
                                <div class="media-body">
                                    ...
                                    <p>Our music classes offer a creative and enjoyable learning experience for all ages
                                        and skill levels.</p>
                                </div>
                            </div>
                        </div>
                        <div class="col-md-12 col-lg-6 d-flex align-self-stretch ftco-animate">
                            <div class="services">
                                ...
                                <div class="media-body">
                                    ...
                                    <p>Our experienced instructor brings a wealth of knowledge and expertise to every
                                        class.</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="block-23 mb-3">
                            <ul>
                                ...
                                <li><a href="#"><span class="icon fa fa-phone"></span><span class="text">+2 392 3929
                                            210</span></a></li>
                                <li><a href="#"><span class="icon fa fa-paper-plane"></span><span class="text">
                                            melolinkmusicclass@gmail.com</span></a></li>
                            </ul>
                        </div>
                    </div>
                </div>
